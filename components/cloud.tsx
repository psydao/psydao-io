...
export const Cloud = ({
  ...
  const { contentBox, ref: containerRef } = useDimensions();
      ...
      {contentBox && (
        <>
          ...
          <Box
            ...
            top="-100%"
            left="-100%"
            boxShadow={`${contentBox.width}px ${contentBox.height}px 30px 0px #f2bebe`}
          ...
          {layers >= 2 && (
            <Box
              ...
              top="-100%"
              left="-100%"
              boxShadow={`${contentBox.width}px ${
                contentBox.height + 25
              }px 70px -50px #ea9a9a`}
