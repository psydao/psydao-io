    ...
    <>
      <Box layerStyle="window" p="6" position="relative" zIndex="0">
        ...
        <Text>
          ...
          pharma, much of the current progress will be stymied. Big Pharma, Big
          Law, and the other big dogs will take these drugs down the wrong path,
        ...
        <Text>
          ...
          Vegas with a head full of mescaline and a lawyer, but the wave rolled
          back when The Man crept in, as The Man always tends to do in our
        ...
        <Text>
          ...
          Europeans, Americans, and more, psychedelics have played an extensive
          role in history. But that role is limited compared to what&#39;s to
          come with democratized access to psychedelics.
        </Text>
        ...
        <Text>
          ...
          Some cryptic chemists looked for ways to produce new psychedelics with
          similar properties to the scheduled substances but, in some cases,
          legal to manufacture and sell, believing that these psychedelics had
          possible therapeutic applications and wishing to extend the sphere of
          human knowledge in this area. An icon among them: Dr. Alexander
          Shulgin.
        </Text>
        <Text>
        ...
        <Text>
          ...
          of his career to psychedelic chemistry. He was convinced that there is
          a wealth of information built into us, with miles of intuitive
          knowledge tucked away in genetic material. Something akin to a library
          containing uncountable reference volumes. Without some means of
          access, there is no way to even begin to guess at the extent and
        ...
        <Text>
          ...
          Shulgin&#39;s work is mostly in the public domain, free for the people
          to use, published in TiHKAL (Tryptamines I Have Known and Loved) and
          PiHKAL (Phenethylamine I Have Known and Loved) in the 1990s. His
          legacy is an open-source wealth of information that allows people to
          access life-changing chemicals.
        </Text>
        <Text>
          ...
          through the world wide web beginning in the late 90s, with public
          domain sites such as Erowid.
        </Text>
        <Text>
        ...
        <Text>
          ...
          and unmonopolizable future for psychedelic research. PsyDAO members
          will be able to vote to allocate funding towards the studies and
          research they believe is most relevant, choose which data is shared,
          and govern how the output of these studies will come to market.
        </Text>
        <Text>
        ...
        <Text>
          ...
          for the ethical development of psychedelics. The goal of PsyDAO is to
          redesign incentives and access from the bottom up - focusing on people
          (patients, recreational users, and spiritual communities), as opposed
          to centralizing ownership within organizations that have intrinsically
          misaligned incentives. We see two distinct, yet complementary
          approaches related to the governance of psychedelic knowledge and
          related intellectual property - open source and community-governed.
        </Text>
        <Text>
        ...
        <Text>
          ...
          by the community. For compounds where intellectual property claims are
        ...
        <Text>
          ...
          create open research and participation markets for known psychedelics,
          selectively distributing rights and benefits to partners and
          contributors.
        </Text>
        ...
        <Text>
          ...
          future. Since that first ape ate a psychedelic mushroom many millennia
          ago, we have been coming back to this moment here, now, apes together
          strong and ready for a psychedelic session. With it comes the
          realization that these molecules open up a whole new level of human
          experience that should be available to everyone who wants it. We must
          ensure that this world is available to anyone.
        </Text>
      </Box>
