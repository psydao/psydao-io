        ...
        >
          ...
          >
            ...
            <Text>
              ...
              spiritual, medicinal, and recreational value to the human race,
              with the lines between those domains often blurred.
            </Text>
            <Image
            ...
            <Text>
              ...
              the mind of Homo sapiens, tool-using wordcels and shape rotators.
              For thousands of years, nature controlled our access to these
              plants.
            </Text>
            <Text>
              ...
              religious movement in history, changing human consciousness
              forever. For hundreds of years, religion controlled our access.
            </Text>
            <Text>
              ...
              rolled back when The Man crept in, as The Man always tends to do
              in our temporary autonomous zones [4], pausing psychedelic
              research for decades. For decades, the state has controlled our
              access.
            </Text>
            <Image
            ...
            <Text>
              ...
              believing that these psychedelics had possible therapeutic
              applications and wishing to extend the sphere of human knowledge
              in this area. An icon among them: Dr. Alexander Shulgin.
            </Text>
            <Text>
              Shulgin was a researcher at Dow Chemical in the 60s when he
              ingested mescaline (which was first isolated and identified by
              Arthur Heffter in 1897, popularized by Alduous Huxley in the Doors
              of Perception in 1954, and contained within hikuri (peyote), and
            ...
            <Text>
              ...
              posts in forums from savvy users - fully open-source, anonymous
              and uncontrolled.
            </Text>
            ...
            <Text>
              ...
              we&#39;re starting with TiHKAL and PiHKAL.
            </Text>
            <Text>
              Web3, crypto, enables users to get involved in funding and
              ownership of IP, like VitaDAO or BAYC, for both the creator
              economy and the scientific community. PsyDAO is using crypto to
              create a decentralized and unmonopolizable future for psychedelic
              research. PsyDAO members will be able to vote to allocate funding
              towards the studies and research they believe is most relevant,
              choose which data is shared, and govern how the output of these
              studies will come to market.
            </Text>
            <Image
            ...
            <Text>
              PsyDAO utilizes new open-source models for IP tokenization,
              IPNFTs, and IP rights distribution, with ethical encumbrances,
            ...
            <Text>
              ...
              incentives. We see two distinct, yet complementary approaches
            ...
            <Text>
              ...
              growing portfolio of IP assets attached to NFTs, which can then be
              made available open-source by the community, or commercialized
              where appropriate in fair ways, using fractional ERC20s called
              FRENS and FAM.
            </Text>
            <Image
