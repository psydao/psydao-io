  ...
  return (
    <>
      ...
      <Text>
        ...
        sativa and preparations with psychedelic effects like ayahuasca,
        ergotized beer, and soma have extensive spiritual, medicinal, and
        recreational value to the human race, with the lines between those
      ...
      <Text>
        ...
        autonomous zones, pausing psychedelic research for decades. For decades,
        the state has controlled our access.
      </Text>
      <Text>
      ...
      <Text>
        ...
        where the secret search for new psychedelic drugs began in earnest. Some
        cryptic chemists looked for ways to produce new psychedelics with
        similar properties to the scheduled substances but, in some cases, legal
        to manufacture and sell, believing that these psychedelics had possible
        therapeutic applications and wishing to extend the sphere of human
        knowledge in this area. An icon among them: Dr. Alexander Shulgin.
      </Text>
      <Text>
        Shulgin was a researcher at Dow Chemical in the 60s when he ingested
        mescaline (which was first isolated and identified by Arthur Heffter in
        1897, popularized by Alduous Huxley in the Doors of Perception in 1954,
        and contained within hikuri (peyote), and other psychedelic cacti like
        San Pedro) for the first time.
      </Text>
      <Text>
        Shulgin found the experience so astonishing that he devoted the rest of
        his career to psychedelic chemistry. He was convinced that there is a
        wealth of information built into us, with miles of intuitive knowledge
        tucked away in genetic material. Something akin to a library containing
        uncountable reference volumes. Without some means of access, there is no
        way to even begin to guess at the extent and quality of what is there.
      </Text>
      <Text>
      ...
      <Text>
        Alexander Shulgin is known for the discovery, synthesis, and personal
        bioassay of over 230 psychoactive compounds for their psychedelic and
        entactogenic potential, and did so in a way that made it impossible to
        patent them. In the context of our current system, many organizations
        have thus far lacked incentives to develop them and explore them
        further. There was only a brief period when they saw the light of day,
        through the world wide web beginning in the late 90s, with public domain
        sites such as Erowid.
      </Text>
      ...
      <Text>
        Web3, crypto, enables users to get involved in funding and ownership of
        IP, like VitaDAO or BAYC, for both the creator economy and the
        scientific community. PsyDAO is using crypto to create a decentralized
        and unmonopolizable future for psychedelic research. PsyDAO members will
        be able to vote to allocate funding towards the studies and research
        they believe is most relevant, choose which data is shared, and govern
        how the output of these studies will come to market.
      </Text>

      <Text>
        Membership in PsyDAO is open to anons, pseudonymous participation is
        encouraged, and privacy protection is paramount. Knowledge and research
        can be shared with zero knowledge of the identity of the sender or
        recipient.
      </Text>

      <Text>
        PsyDAO utilizes new open-source models for IP tokenization, IPNFTs, and
        IP rights distribution, with ethical encumbrances, through fungible
        tokens.
      </Text>

      <Text>
        PsyDAO intends to be a hivemind - a literal collective consciousness for
        the ethical development of psychedelics. The goal of PsyDAO is to
        redesign incentives and access from the bottom up - focusing on people
        (patients, recreational users, and spiritual communities), as opposed to
        centralizing ownership within organizations that have intrinsically
        misaligned incentives. We see two distinct, yet complementary approaches
        related to the governance of psychedelic knowledge and related
        intellectual property - open source and community-governed.
      </Text>

      <Text>
        PsyDAO will directly hold IP rights in underlying research projects that
        it supports, where applicable. PsyDAO will develop a growing portfolio
        of IP assets attached to NFTs, which can then be made available
        open-source by the community, or commercialized where appropriate in
        fair ways, using fractional ERC20s called FRENS and FAM.
      </Text>

      <Text>
        For naturally-occurring compounds such as psilocybin, PsyDAO aims to
        create powerful, open-source data repositories that will be governed by
        the community. For compounds where intellectual property claims are
        possible, we will develop a portfolio that is actively managed by the
        community in an aligned way promoting democratized access.
      </Text>

      <Text>
        A mixture of meme magic and mathemagic, the IP tokenization system built
        with our friends at Molecule and VitaDAO enables PsyDAO to create open
        research and participation markets for known psychedelics, selectively
      ...
      <Text>
        ...
        a radical shift in consciousness to preserve its light for the future.
        Since that first ape ate a psychedelic mushroom many millennia ago, we
        have been coming back to this moment here, now, apes together strong and
        ready for a psychedelic session. With it comes the realization that
        these molecules open up a whole new level of human experience that
        should be available to everyone who wants it. We must ensure that this
